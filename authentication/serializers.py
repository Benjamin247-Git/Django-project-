...
class UserCrudSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = User
        fields = ('first_name', 'last_name', 'about', 'facebook', 'twitter', 'instagram', 'youtube', 'state', 'country', 'verify_author', 'mobile_no')
...
class LoginSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = User
        fields = ['email', 'password', 'username', 'tokens', 'is_driver', 'id', 'is_passenger', 'image']
...
class MessageBoxSerializer(serializers.Serializer):
